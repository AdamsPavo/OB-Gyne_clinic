...
export default function Login() {
  ...
  const features = [
    { icon: <HeartPulse className="text-pink-500 mx-auto" />, title: "Patient Care", text: "Comprehensive women's healthcare." },
    { icon: <CalendarDays className="text-pink-500 mx-auto" />, title: "Appointments", text: "Easy scheduling and reminders." },
    { icon: <FileText className="text-pink-500 mx-auto" />, title: "Medical Records", text: "Secure patient records." },
  ];
    ...
    <div className="min-h-screen flex bg-linear-to-br from-[#fff7fa] via-white to-[#ffe6ef] overflow-hidden relative">
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center px-20">
        <div className="text-center h-full w-full flex flex-col justify-center">
          <img src={Logo} alt="Hero" className="w-220r mx-auto"/>
          
          <div className="grid grid-cols-3 gap-5 mt-10">
            {features.map((f)=>(
              <div key={f.title} className="bg-white rounded-3xl p-6 shadow-lg border border-pink-100">
                {f.icon}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-linear-to-br from-pink-500/90 via-rose-400/90 to-pink-300/90 backdrop-blur-2xl rounded-[40px] border border-white/30 shadow-[0_25px_70px_rgba(236,72,153,.35)] p-10">
          ...
          <h2 className="text-center text-5xl font-bold text-gray-800">Welcome Back</h2>
          <p className="text-center text-gray-500 mt-3 mb-8">Login to access your clinic dashboard</p>

          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              <label className="font-semibold text-sm">Username</label>
              <div className="relative mt-2">
                <User size={20} className="absolute left-4 top-4 text-pink-500"/>
            ...
            <div>
              ...
              <div className="relative mt-2">
                <Lock size={20} className="absolute left-4 top-4 text-pink-500"/>
            ...
            <button type="submit" className="w-full py-4 rounded-2xl bg-linear-to-r from-pink-500 to-rose-500 text-white font-semibold flex items-center justify-center gap-2 hover:-translate-y-1 transition">
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-xs text-gray-400 mt-2">© 2026 Perdido OB-GYN Clinic</p>
          </div>
        </div>
      </div>
    </div>
